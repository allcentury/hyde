...
In 2020, during the COVID pandemic I had moved into a leadership role at Braintree and it was the first time I really thought about trying to define "my leadership style".  My entire career, I've focused on "doing the right thing" and doubling down on whatever existing intuition I had built from watching others.  But for this exercise, I tried to divoce my current style from one that I'd want to lead with.  Simply, I started from zero.  I did the zero-to-leadership booklist that probably everyone has gone through at some point, you know:
...
So this has been running now since May 27th, 2021 and while I have moved on with my life and really found my leadership style (separate post coming) I still get emails.  Not only do I still get emails but I've been storing the results of the API the entire time because I wanted the lambda to only email me if there were new jobs that I hadn't seen before.

So with my S3 bucket results, I thought, well maybe I should do something with this data.
...
Next, I thought it would be interesting to see where these jobs are located.  I've been looking at the job board for a while and I've noticed that the majority of jobs are in Los Gatos, CA.  But I wanted to see if that was true over time.  Here's what that looks like:
